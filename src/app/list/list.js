...
.controller('ListCtrl', function($scope, $window, $rootScope, ListService, HomeService, Session) {
  ...
  $scope.unsubscribe = function() {
    if ($window.confirm('Are you sure you want to unsubscribe from this list?!')) {
